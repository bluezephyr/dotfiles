...
vim.keymap.set('n', '<leader>e',  "<cmd>wqa<CR>", { desc = 'Exit nvim and save all' })
vim.keymap.set('n', '<leader>x',  "<cmd>split<CR>", { desc = 'Split window' })
vim.keymap.set('n', '<leader>z',  "<cmd>close<CR>", { desc = 'Close window' })
...
vim.keymap.set("n", "<leader>ga", "<cmd>Gitsigns blame<cr>", { desc = "Git blame" })
